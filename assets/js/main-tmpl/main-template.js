var addactions = function(actions)
{
	for (var i = 0; i < actions.length; ++i) 
	{
	  ...
	  var base_url = '~/../wp-content/themes/twentyseventeen/assets/images/cliently-images';
...
var addAuthorDetails = function(author)
{
    ...
    {
    	  var addDiv, stepname ,imgpath ,action_detail;
  	      var base_url_back = 'http://localhost/cliently_cms/uploads';
...
//	  			      $(modal).find('.modal-header > h4 ').append( 'STEP ' + position + ' ' + action);
	  			      ...
	  			      gift_card_amount.append('<p>These will cost 35 creits each and includes the handwritten message as well as postage.</p>');
